  ...
  <header>
   ...
   <p>Se enviaran tus credenciales mediante correo</p>
                ...
                <!-- Password input -->
                <div class="form-outline mb-4">
                  <input type="text" name="clave" id="form1Example2" class="form-control" />
                  <label class="form-label" for="form1Example2">Matricula:</label>
                </div>
