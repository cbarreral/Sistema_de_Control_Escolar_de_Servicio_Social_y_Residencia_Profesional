            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <a href="http://localhost/Sistema/catalogo" class="btn btn-default ">Cancelar</a>
                        <p id="respuesta">
...
<script>
    $('#btn_lectura').click(function () {
        ...
        $('#my_file_output tr').each(function () {
            ...
            valor=new Array(d1, d2, d3, d4,d5, d6);
            valores.push(valor);
            console.log (valor);
           // alert(valor);
            $.post('insertarCatalogo.php', {d1:d1, d2:d2, d3:d3, d4:d4,d5:d5, d6:d6}, function (datos) {
